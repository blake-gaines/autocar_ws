...
desired_trajectory = 0.4	# distance from the wall (left or right - we cad define..but this is defined for right). You should try different values
vel = 5 		# this vel variable is not really used here.
error = 0.0


pub = rospy.Publisher('error3', pid_input, queue_size=10)
pub1 = rospy.Publisher('env3', drive_values, queue_size=10)
...
if __name__ == '__main__':
	...
	rospy.Subscriber("scan3",LaserScan,callback)
