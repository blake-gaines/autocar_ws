...
angle_pub         = rospy.Publisher('/commands/servo/position3', Float64, queue_size = 1)
speed_pub         = rospy.Publisher('/commands/motor/duty_cycle3', Float64, queue_size = 1)
...
if __name__ == '__main__':
	...
	rospy.Subscriber("error3", pid_input, control)
	rospy.spin()
